...
class Brain{
    ...
    public char guessLetter(){
        ...
        boolean chosen = true;
        char letter = '_';
        //System.out.println(chosenletters.size());

        if(chosenletters.size() == 0)
        {
            chosenletters.push('a');
            return 'a';
        }
        else if(chosenletters.size() == 1)
        {
            chosenletters.push('e');
            return 'e';
        }
        else if(chosenletters.size() == 2)
        {
            chosenletters.push('i');
            return 'i';
        }
        else if(chosenletters.size() == 3)
        {
            chosenletters.push('r');
            return 'r';
        }
        else if(chosenletters.size() == 4)
        {
            chosenletters.push('o');
            return 'o';
        }
        chosenletters.push('x');
        chosenletters.push('z');
        chosenletters.push('j');
        chosenletters.push('q');
        //chosenletters.push('k');
